    ...
    <div class="container-fluid px-4">
                ...
                <div class="card bg-success text-white mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div style="font-size: 1.5rem; font-weight: bold;">{{ $appointment }}</div>
                        </div>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="#">View Details</a>
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                Top Doctors
                <div class="d-flex justify-content-end" style="margin-top: -20px;"><a href="{{ route('doctor.index') }}"
                        class="btn btn-primary">Manage Doctor</a></div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($doctors as $doctor)
                            <tr>
                                ...
                                <td>{{ $doctor->fee }}</td>
                                <td>
                                    <img src="{{ asset($doctor->image) }}" alt="" class="img-fluid" width="50px"
                                        height="50px">
                                </td>
