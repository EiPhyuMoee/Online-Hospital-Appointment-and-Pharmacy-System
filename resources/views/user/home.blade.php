                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 py-3 py-md-0">
                        <div class="card-service wow fadeInUp">
                            ...
                            <p><span>Appointment </span>Section</p>
                        </div>
                    </div>
                    <div class="col-md-4 py-3 py-md-0">
                        <div class="card-service wow fadeInUp">
                    ...
                    <div class="col-md-4 py-3 py-md-0">
                        <div class="card-service wow fadeInUp">
                            ...
                            <p><span>Doctor Trust</span> Section</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 py-3 wow fadeInUp">
                    ...
                    <p class="text-grey mb-4">Our hospital is a place where you can receive healthcare services with
                        complete trust and confidence.<br>
                        ...
                        <div class="card-doctor shadow-sm border-0 rounded-4 overflow-hidden">
                            ...
                            <div class="body text-center py-3 px-2">
                                <h5 class="mb-1 fw-semibold">
                                    <a href="{{ route('doctor-details', ['id' => $doctors->id]) }}"
                        ...
                        <div class="card-blog">
                            ...
                            <div class="body">
                                <h5 class="post-title"><a
                                        href="{{ route('blog-details', ['id' => $blogs->id]) }}">{{ $blogs->title }}</a>
                                </h5>
                                <div class="site-info">
                                    ...
                                    <small>{{ \Carbon\Carbon::parse($blogs->date)->diffForHumans() }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
